...
set src_path=.\client_server_proto\client_shop\
set dest_path=..\pb\client_shop\
set rpc_map_file=client_shop
@echo on
...
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\client_server_proto\client_shop -I=..\easygo\base\ -I=.\share_message\ -I=.\client_server_proto --gogofast_out=..\pb\client_shop client_server_proto\client_shop\*.proto


set src_path=..\pb\client_shop\
