...
set src_path=.\client_server_proto\client_topic\
set dest_path=..\pb\client_topic\
set rpc_map_file=client_topic
@echo on
...
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\client_server_proto\client_topic -I=..\easygo\base\ -I=.\share_message\ -I=.\client_server_proto --gogofast_out=..\pb\client_topic client_server_proto\client_topic\*.proto


set src_path=..\pb\client_topic\
