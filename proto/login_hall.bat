...
set src_path=.\login_hall\
set dest_path=..\pb\login_hall\
set rpc_map_file=login_hall
@echo on
...
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\login_hall -I=..\easygo\base\ -I=.\share_message -I=.\ --gogofast_out=..\pb\login_hall login_hall\*.proto


set src_path=..\pb\login_hall\
