...
set src_path=.\h5_server_proto\h5_wish\
set dest_path=..\pb\h5_wish\
set rpc_map_file=h5_wish
@echo on
...
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\h5_server_proto\h5_wish -I=..\easygo\base\ -I=.\share_message\ -I=.\h5_server_proto --gogofast_out=..\pb\h5_wish h5_server_proto\h5_wish\*.proto


set src_path=..\pb\h5_wish\
