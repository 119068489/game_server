...
set src_path=.\brower_backstage_proto\
set dest_path=..\pb\brower_backstage\
set rpc_map_file=brower_backstage
@echo on
...
rem ==================================================
@echo on
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\brower_backstage_proto -I=..\easygo\base\ -I=.\share_message --gogofast_out=..\pb\brower_backstage brower_backstage_proto\*.proto 

set src_path=..\pb\brower_backstage\
