...
set src_path=.\client_server_proto\client_login\
set dest_path=..\pb\client_login\
set rpc_map_file=client_login
@echo on
...
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\client_server_proto\client_login -I=..\easygo\base\ -I=.\share_message -I=.\client_server_proto --gogofast_out=..\pb\client_login client_server_proto\client_login\*.proto


set src_path=..\pb\client_login\
