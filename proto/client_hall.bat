...
set src_path=.\client_server_proto\client_hall\
set dest_path=..\pb\client_hall\
set rpc_map_file=client_hall
@echo on
...
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\client_server_proto\client_hall -I=..\easygo\base\ -I=.\share_message\ -I=.\client_server_proto --gogofast_out=..\pb\client_hall client_server_proto\client_hall\*.proto


set src_path=..\pb\client_hall\
