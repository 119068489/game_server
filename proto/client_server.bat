...
set src_path=.\client_server_proto\
set dest_path=..\pb\client_server\
set rpc_map_file=client_server
@echo on

python make_rpc_service.py src=%src_path% dest=%dest_path% rpc_map_file=%rpc_map_file%

@echo on
call protoc.exe -I=..\..\github.com\akqp2019\protobuf\protobuf\ -I=..\..\ -I=.\client_server_proto -I=..\easygo\base\ -I=.\share_message --gogofast_out=..\pb\client_server client_server_proto\*.proto 

set src_path=..\pb\client_server\
