...
func Entry(flagSet *flag.FlagSet, args []string) {
	...
	dict := easygo.KWAT{
		"logName":  SERVER_NAME,
		"yamlPath": "config_sport_lottery_lol.yaml",
	}
...
func SignHandle() {
	...
	for {
		...
		case syscall.SIGTERM:
			//TODO:服务器关闭逻辑处理
			logs.Info("LOL开奖服务器关闭", PServerInfo.GetSid())
...
func TimedTask() {
	...
	saveServerSid := for_game.GetCurrentSaveServerSid(sid, for_game.REDIS_SAVE_ESPORTS_LOL_SID)
