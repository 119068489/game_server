...
//模拟抽奖工具通知抽奖结果
func (self *WebHttpForServer) RpcWishToolLucky(common *base.Common, reqMsg *h5_wish.BackstageDareToolReq) easygo.IMessage {
	ep := BrowerEpMp.LoadEndpoint(reqMsg.GetUserId())
	if ep != nil {
		ep.RpcToolLuckyPush(nil)
	}
